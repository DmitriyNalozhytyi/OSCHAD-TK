...
public class RestTestPrivateBank {
    ...
    public void getCursDetails(){
        ...
        CurrencyValues[] responseStructure = apiPrivateBank.getRequestToPrivateBankApi(4);

        for (CurrencyValues currencyElement : responseStructure ) {
            System.out.println("Cur1 " + currencyElement.ccy + " to " + currencyElement.base_ccy + " has for buy " + currencyElement.buy + " and for sale " + currencyElement.sale);
        }
    }
}
