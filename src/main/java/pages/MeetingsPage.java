...
public class MeetingsPage extends ParentPage {
    ...
    @FindBy(id = "LSCMTMembers_375a776d-4e56-4beb-a8ee-d8d84673622f_$ClientPeoplePicker")
    private WebElement members;

    @FindBy(id = "LSCMTClerk_3f64f882-a3e3-4398-9c4b-3383ef7d7eed_$ClientPeoplePicker")
    ...
    @FindBy(id = "LSCMTChairman_cb342a13-b819-4c38-aba1-0506edd26131_$ClientPeoplePicker_i:0#.w|competence\\alla.soroka_ProcessedUser5_DeleteUserLink")
    private WebElement deleteChairman;
